...
"""
Only including redshifts 7,8,9
Got rid of redshift evolution
Added different uppers & lowers on parameters based on zooming into the best fit region
Held beta & log(Mc) fixed at values determined by the z = 4,5,6 run
"""

# Name this run
run_name = '789-narrowed_fixed_parameters'
...
# Get ICs
lowers = [0.52, -1.56, 0.07, -0.43]
uppers = [1.29, -0.31, 1.1, 0.34]
