...
"""
Only including redshifts 4, 5, and 6 (line 20)
Got rid of redshift evolution (line 24)
Added special ICs based on zooming in on the best fit region from prior runs
Held beta & log(Mc) fixed at values determined by the z = 4,5,6 run
"""

# Name this run
run_name = '456-narrowed'
...
# Get ICs
lowers = [0.59, -1.03, 11.69, -0.87, 0.06, -1.29]
uppers = [2.75, -0.39, 13.89, -0.79, 3.45, 0.11]
