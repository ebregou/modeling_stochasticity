...
# Name this run
run_name = 'best_fit_sig_free_narrowed'
...
params = eMCMC.build_param_data({'beta': {'fit':False, 'value': -0.54}, 'dbetadz': {'fit': False, 'value':0}, 'min_sig':{'fit': True}})
...
lowers = [0.61, -0.04, 11.13, -0.18, -2.13, -0.17, 0, 0, -0.93, 0.3]
uppers = [1.01, 0.07, 12.36, 0.11, -1, -0.05, 1.27, 0.27, 0.08, 0.71]
